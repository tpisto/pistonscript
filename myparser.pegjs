/* PistonScript */
/* based on peg.js javascript grammar */
{
  var ps = require('ast.js')
...
Program
  = body:SourceElements? { return new ps.Program({ body: body }) }
...
VarToken        = t:"var"      !IdentifierPart { return t }
                / t:"let"      !IdentifierPart { return t }
                / t:"const"    !IdentifierPart { return t }

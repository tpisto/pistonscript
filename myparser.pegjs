...
Program
  = body:SourceElements? { return new ps.Program(body) }

SourceElements
  = first:SourceElement rest:(__ SourceElement)* { return { first: first, rest: rest } }
...
Block
  = "{" __ body:(StatementList __)? "}" { return new ps.BlockStatement(body) }

StatementList
  = first:Statement rest:(__ Statement)* { return { first: first, rest: rest } }
